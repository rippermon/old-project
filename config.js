...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By Bixby-mowl' : process.env.ALL_CAPTION,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'Bixby-mowl bot' : process.env.BOT_NAME,
