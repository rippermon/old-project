...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to Bixby-mowl voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
if (conf.LANG == 'TR') {
    ...
    already_on = 'Ripperser yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'Ripperser yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'Ripperser, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'Ripperser, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional Pikachu features. Turn your account into a ai chatbot!'
    already_on = 'Ripperser artificial intelligence is already fully functional.'
    already_off = 'Ripperser artificial intelligence is currently running semi-functional.'
    succ_on = 'Ripperser Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'Ripperser Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
